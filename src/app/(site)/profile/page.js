          ...
          ? (
            <div className=" flex flex-col items-center">
              <div className="flex justify-between mb-14 mt-5 w-11/12 ">
                <div onClick={() => setShowProfileImage(true)} className="border border-red-6000">
                  {
              ...
              <div className="w-11/12">
                <div className=" flex justify-center gap-5 items-center border-b border-stone-300 text-[15px]">
                  <div
                    ...
                    className="cursor-pointer flex gap-1 items-center font-medium border-b px-2.5 pb-1.5"
                  >
                    <Grid3X3 size={18} />
                    Posts
                  </div>
                  <div
                    ...
                    className="cursor-pointer flex gap-1 items-center text-stone-500 px-2 pb-1.5"
                  >
                    <Bookmark size={18} />
                    Saved
                  </div>
