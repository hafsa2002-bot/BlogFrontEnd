        ...
        <>
            <div className='bg-[#fcf8eff5] flex justify-center items-center border-b border-black fixed top-0 w-full z-50'>
                ...
                <div className='flex gap-4'>
                    ...
                    <Link href="/" className=' font-semibold cursor-pointer hover:bg-[#fcc7a3] text-sm  px-2.5 py-1.5 rounded-full '>About</Link>
                    <div className=' font-semibold cursor-pointer hover:bg-[#fcc7a3]  px-2.5 text-sm  py-1.5 rounded-full '>Contact</div>
                    ...
                    <div className='cursor-pointer bg-[#F27C3A] px-4 py-1.5 rounded-full font-semibold text-sm text-white'>Sign Up</div>
            ...
            <section className="flex justify-center overflow-hidden " >
                <div className="flex-col flex justify-center h-[75vh] w-11/12 pl-4">
                    ...
                    <Link href="/home/explore-page" className="bg-[#F27C3A] w-48 rounded-full text-center font-semibold py-3 text-xl cursor-pointer hover:bg-[#fcf8eff5] border hover:border-2 border-black hover:drop-shadow-lg transition-colors duration-300  ">Start reading</Link>
                </div>
                <div className="h-[90vh] w-1/3 absolute z-10 right-0 bottom-5">
