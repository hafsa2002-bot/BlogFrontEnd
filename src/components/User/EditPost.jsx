...
function EditPost({postId, setPost, content, setEditPostPopUp, author}) {
    ...
    <div  className='w-screen h-screen top-0  right-0 fixed z-50 flex justify-center items-center ' style={{ backgroundColor: "rgba(0, 0, 0, 0.7)" }}>
        ...
        >
            <div className='relative px-5 py-3 flex justify-between border-b border-stone-300'>
                <div
                    onClick={() => setEditPostPopUp(false)} 
                ...
                {success && 
                    ...
                    //     {success} <div className='w-5 h-5 rounded-full bg-green-700 text-white flex justify-center items-center'> <Check size={15} strokeWidth={2} /></div> 
                    // </div>
